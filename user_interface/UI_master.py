...
class MyGUI(QMainWindow):
    ...
    def __init__ (self, default_create_new_account, default_year, default_new_transactions_file_dir, default_account_location, default_exsisting_form, main_program_function):
    ...
    def select_csv_transactions(self):
        ...
        fileName, _ = QFileDialog.getOpenFileName(self, caption="Velg fil", directory=default_dir, filter="CSV-fil (*.csv)", options=options)
        self.lineEdit_new_transactions_file.setText(fileName)
    ...
    def select_exsisting_account(self):
        ...
        options = QFileDialog.Options()
        fileName, _ = QFileDialog.getOpenFileName(self, caption="Velg regnskap", directory=default_dir, filter="Excel file (*.xlsx)", options=options)
        self.lineEdit_selcet_exsisting_account.setText(fileName)
    ...
    def save_new_account(self):
        ...
        fileName, _ = QFileDialog.getSaveFileName(self, caption="Lagre som", directory=self.default_account_location, filter="Excel file (*.xlsx)", options=options)
        self.lineEdit_save_new_account_as.setText(fileName)
    ...
    def attempt_to_run(self):
        ...
        try:
            success, message, title = self.main_program_function(create_new_account, csv_transactions_file, year, account_filepath)
...
def run_GUI(default_create_new_account, default_year, default_new_transactions_file_dir, default_account_location, default_exsisting_form, main_program_function):
    app = QApplication([])
    win = MyGUI(default_create_new_account, default_year, default_new_transactions_file_dir, default_account_location, default_exsisting_form, main_program_function)
    app.exec_()
...
if __name__ == "__main__":
    ...
    run_GUI(default_create_new_account, default_year, default_new_transactions_file_dir, default_account_location, default_exsisting_form, run_main_program_debug)
